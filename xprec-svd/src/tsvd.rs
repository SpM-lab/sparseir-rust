...
pub fn tsvd_df64(
    matrix: &Tensor<crate::precision::Df64Precision, (usize, usize)>,
    rtol: crate::precision::Df64Precision,
) -> Result<crate::svd::jacobi::SVDResult<crate::precision::Df64Precision>, TSVDError> {
...
pub fn tsvd_df64_from_f64(
    ...
    // Convert f64 matrix to Df64Precision
    let shape = *matrix.shape();
    let (m, n) = shape;
    let matrix_tf = Tensor::from_fn((m, n), |idx| {
        crate::precision::Df64Precision::from_f64(matrix[[idx[0], idx[1]]])
    });

    tsvd_df64(&matrix_tf, crate::precision::Df64Precision::from_f64(rtol))
}
