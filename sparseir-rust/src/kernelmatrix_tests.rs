...
use crate::kernel::{
    ...
    SymmetryType, SVEHints, KernelProperties, CentrosymmKernel
};
use crate::kernelmatrix::{matrix_from_gauss, InterpolatedKernel};
    ...
    K: CentrosymmKernel + KernelProperties + Clone,
{
    ...
    println!("Segments: {}x{}", segments_x.len()-1, segments_y.len()-1);
    ...
    println!("Interpolated kernel created: {}x{} cells", 
...
fn test_logistic_kernel_interpolation_f64() {
    test_kernel_interpolation_both_symmetries::<f64, _, _>(
        ...
        |k, eps| LogisticSVEHints::new(k, eps),
        "LogisticKernel (f64)",
        1e-12,      // epsilon
...
fn test_regularized_bose_kernel_interpolation_f64() {
    test_kernel_interpolation_both_symmetries::<f64, _, _>(
        ...
        |k, eps| RegularizedBoseSVEHints::new(k, eps),
